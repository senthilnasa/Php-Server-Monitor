...
<head>
    <title>Bitsathy Server Management | Admin </title>
...
<header>
        ...
        <ul id="slide-out" class="sidenav sidenav-fixed">
            ...
            <li><a href="../log"><i class="material-icons">assignment_ind</i>User Management</a></li>
            <li><a href="../log"><i class="material-icons">notification_important</i>Notification Log</a></li>
